  ...
  <div>
    ...
    <div class="header">
      <div class="header-left">
        <img src="@/assets/imgs/logo.jpg" style="width: 150px;height: 150px" alt="">
        <div class="title"></div>
      </div>
      <div class="header-center">
        <div class="header-nav">
          <el-menu :default-active="$route.path" mode="horizontal" router>
            ...
            <el-menu-item v-if="user.role !== 1" index="/front/payOrder">购买订单</el-menu-item>
            <el-menu-item v-if="user.role !== 1" index="/front/sellOrder">出售订单</el-menu-item>
            <el-menu-item v-if="user.role !== 1" index="/front/myGoods">我的闲置</el-menu-item>
            <el-menu-item v-if="user.role !== 1" index="/front/cart">我的购物车</el-menu-item>
            <el-menu-item v-if="user.role !== 1" index="/front/collect">我的收藏</el-menu-item>
          </el-menu>
        </div>
      </div>
        ...
        <div v-else>
          <el-dropdown>
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item v-if="user.role === 2">
                <div @click="goToAddress()">我的地址</div>
              </el-dropdown-item>
              <el-dropdown-item>
