  ...
  <div>
    ...
    <div>
      <div class="main-body-content">
        <div>
					<el-input size="small" class="main-input" placeholder="请输入昵称" v-model="search.username"></el-input>
        ...
        <div class="main-table-box">
          <el-table style="width: 100%" :data="tableData" size="small" strip header-cell-class-name="tableHeaderClass" >
						...
						<el-table-column label="学号" prop="studyNum"></el-table-column>
    ...
    <el-dialog title="请填写信息" :visible.sync="dialogVisible" width="40%">
      <el-form :model="form" label-position="right" label-width="100px" style="padding-right: 40px">
				...
				<el-form-item label="学号">
					<el-input size="small" v-model="form.studyNum" placeholder="请输入学号"></el-input>
				</el-form-item>
        <el-form-item label="手机号">
          <el-input size="small" v-model="form.phone" placeholder="请输入手机号"></el-input>
        </el-form-item>
        <el-form-item label="邮箱">
          <el-input size="small" v-model="form.email" placeholder="请输入邮箱"></el-input>
        </el-form-item>
