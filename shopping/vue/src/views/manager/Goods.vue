<template>
  <div>
    <div class="main-body-header">商品管理</div>
    <div>
      <div class="main-body-content">
        <div>
					<el-input size="small" class="main-input" placeholder="请输入商品名称" v-model="params.name"></el-input>
    ...
    <el-dialog title="请填写信息" :visible.sync="dialogVisible" width="40%">
      <el-form :model="form" label-position="right" label-width="100px" style="padding-right: 40px">
        ...
        <el-form-item label="商品数量">
          <el-input size="small" v-model="form.num" placeholder="请输入商品价格"></el-input>
        </el-form-item>
  ...
  methods: {
    ...
    del(id) {
      ...
      delBatch(){
          ...
          request.post("goods/delBatch",this.multipleSelection).then(res=>{
              if (res.code === '0') {
