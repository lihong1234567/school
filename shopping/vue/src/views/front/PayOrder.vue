  ...
  <div class="main-content">
    <div>
      <div class="main-table-box">
        <div style="height: 50px; line-height: 50px; font-weight: bold; font-size: 15px">购买订单</div>
        <el-table :data="orderData" size="small" strip header-cell-class-name="tableHeaderClass" >
...
<!--          <el-table-column label="下单人" prop="userName"></el-table-column>-->
          ...
          <el-table-column label="操作" fixed="right" width="200">
            <template v-slot="scope">
              ...
              <el-button type="primary" v-if="scope.row.status === '待支付'" @click="buy(scope.row)" style="margin-right: 5px">支付</el-button>
...
export default {
  ...
  methods: {
    ...
    buy(row) {
      ...
      request.post("/order/buy", row).then(res => {
        if (res.code === '0') {
